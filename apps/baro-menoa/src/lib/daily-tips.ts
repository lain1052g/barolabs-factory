...
export const TIPS: Tip[] = [
  ...
  },
  {
    ...
    emoji: '☕',
    title: '카페인과 안면홍조',
    body: '카페인은 혈관을 확장시켜 안면홍조를 악화시킬 수 있어요. 하루 아메리카노 1잔 이하로 줄여보세요.',
  },
  {
    id: 'hf03',
    category: 'hotflash',
    emoji: '🌡️',
    title: '침실 온도가 중요해요',
    body: '취침 시 침실 온도를 18~20°C로 맞추면 야간발한이 줄어요. 얇은 이불 여러 장을 겹쳐 조절하는 것도 좋아요.',
  },
  {
    id: 'hf04',
    category: 'hotflash',
    emoji: '🍵',
    title: '두부 한 모의 효과',
    body: '두부에는 이소플라본이 풍부해요. 매일 두부 150g 또는 된장국 한 그릇이 안면홍조를 줄이는 데 도움이 될 수 있어요.',
  },
  {
    id: 'hf05',
    category: 'hotflash',
    emoji: '🍷',
    title: '음주와 야간발한',
    body: '알코올은 혈관을 확장해 안면홍조와 야간발한을 유발해요. 증상이 심한 날은 음주를 피해보세요.',
  },
  {
    id: 'hf06',
    category: 'hotflash',
    emoji: '💧',
    title: '물을 충분히 드세요',
    body: '하루 1.5~2L 수분 섭취가 체온 조절에 도움이 돼요. 안면홍조가 올 때 차가운 물 한 잔이 즉각적인 완화에 도움이 됩니다.',
  },
  ...
  // ── 수면 ──────────────────────────────────────────────────────
  {
    ...
    emoji: '🌙',
    title: '잠들기 어려울 때',
    body: '취침 1시간 전부터 스마트폰을 내려놓으세요. 블루라이트가 수면 호르몬(멜라토닌) 분비를 방해해요.',
  },
  {
    id: 'sl02',
    category: 'sleep',
    emoji: '🥜',
    title: '마그네슘은 수면 친구',
    body: '마그네슘은 근육 이완과 수면 질에 도움이 돼요. 아몬드 28g, 호박씨 한 줌으로 자연스럽게 섭취할 수 있어요.',
  },
  {
    id: 'sl03',
    category: 'sleep',
    emoji: '⏰',
    title: '기상 시간을 일정하게',
    body: '주말에도 같은 시간에 일어나면 생체리듬이 안정돼요. 불규칙한 기상이 수면 장애를 악화시킬 수 있어요.',
  },
  {
    id: 'sl04',
    category: 'sleep',
  ...
  },
  {
    ...
    emoji: '🚶',
    title: '15분 산책의 마법',
    body: '가볍게 15분 걸으면 세로토닌이 분비돼 기분이 나아져요. 햇빛을 받으며 걸으면 비타민D까지 챙길 수 있어요.',
  },
  {
    id: 'md03',
    category: 'mood',
    emoji: '🐟',
    title: '오메가-3와 기분',
    body: '오메가-3가 풍부한 고등어, 삼치, 연어를 주 2회 드세요. 세로토닌 생성에 도움이 돼 기분 안정에 좋아요.',
  },
  {
    id: 'md04',
    category: 'mood',
  ...
  // ── 영양 ──────────────────────────────────────────────────────
  {
    ...
    emoji: '🥛',
    title: '칼슘, 지금 충분한가요?',
    body: '폐경 후엔 골밀도가 빠르게 낮아져요. 하루 700mg 칼슘 — 우유 200ml 2잔, 멸치 30g으로 채울 수 있어요.',
  },
  {
    id: 'nt02',
    category: 'nutrition',
  ...
  },
  {
    ...
    emoji: '🌾',
    title: '정제 탄수화물 주의',
    body: '흰쌀, 흰 빵, 단 음료는 혈당을 빠르게 올려 안면홍조를 악화시킬 수 있어요. 잡곡, 현미로 바꿔보세요.',
  },
  {
    id: 'nt04',
    category: 'nutrition',
  ...
  },
  {
    ...
    emoji: '🧄',
    title: '식이섬유로 혈당 잡기',
    body: '채소를 밥보다 먼저 먹으면 혈당 상승이 완만해져요. 갱년기엔 혈당 조절이 증상 관리에 중요해요.',
  },
  ...
  // ── 운동 ──────────────────────────────────────────────────────
  {
    ...
    emoji: '🏃',
    title: '걷기만 해도 충분해요',
    body: '빠른 걷기 30분이면 안면홍조 빈도를 29% 줄일 수 있어요 (Cochrane 연구). 오늘 저녁 10분이라도 나가보세요.',
  },
  {
    id: 'ex02',
    category: 'exercise',
    emoji: '🏋️',
    title: '근력 운동이 뼈를 지킨다',
    body: '폐경 후엔 근육량과 골밀도가 빠르게 줄어요. 주 2회 가벼운 근력 운동이 장기적으로 큰 차이를 만들어요.',
  },
  {
    id: 'ex03',
    category: 'exercise',
    emoji: '🧘',
    title: '요가로 몸과 마음 동시에',
    body: '요가는 스트레스 호르몬(코르티솔)을 낮추고 체온 조절을 도와요. 갱년기 여성에게 효과가 검증된 운동이에요.',
  },
  {
    id: 'ex04',
    category: 'exercise',
  ...
  },
  {
    ...
    emoji: '🚭',
    title: '흡연은 증상을 악화시켜요',
    body: '흡연 여성은 비흡연 여성보다 안면홍조가 더 심하고, 폐경이 1~2년 더 일찍 와요. 금연이 지금 할 수 있는 가장 좋은 선택이에요.',
  },
  {
    id: 'gn05',
    category: 'general',
